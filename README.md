...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [Sherlock](https://github.com/sherlock-project/sherlock) | 87k | Python | Hunts a username across hundreds of social networks and websites to find a person's accounts. |
...
| [alterx](https://github.com/projectdiscovery/alterx) | 982 | Go | Pattern-based subdomain wordlist/permutation generator for active enumeration. |
...
| [Bellingcat ShadowFinder](https://github.com/bellingcat/ShadowFinder) | 594 | Python | Estimates possible locations of a photo from a known shadow length and timestamp. |
