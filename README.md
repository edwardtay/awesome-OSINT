...
| [SpiderFoot](https://github.com/smicallef/spiderfoot) | 19k | Python | Automated OSINT engine with 200+ modules correlating data on IPs, domains, emails, names and more. |
...
| [gOSINT](https://github.com/Nhoya/gOSINT) | 670 | Go | Modular CLI OSINT framework for emails, PGP, Telegram and more. ⚠️ |
...
| [EmailHarvester](https://github.com/maldevel/EmailHarvester) | 955 | Python | Retrieves a domain's email addresses from multiple search engines. |
| [MailFinder](https://github.com/mishakorzik/MailFinder) | 567 | Python | OSINT tool to find an email address from a first and last name. |
| [EmailFinder](https://github.com/Josue87/EmailFinder) | 421 | Python | Searches a domain's emails through search engines. ⚠️ |
...
| [chaos-client](https://github.com/projectdiscovery/chaos-client) | 869 | Go | Client for ProjectDiscovery's Chaos dataset of internet-wide DNS/subdomain data. |
...
| [alterx](https://github.com/projectdiscovery/alterx) | 975 | Go | Pattern-based subdomain wordlist/permutation generator for active enumeration. |
...
| [GCPBucketBrute](https://github.com/RhinoSecurityLabs/GCPBucketBrute) | 566 | Python | Enumerates Google Storage buckets and checks for privilege-escalation paths. |
...
| [Kamerka](https://github.com/woj-ciech/Kamerka-GUI) | 856 | Python | Maps exposed IoT devices, webcams, and ICS on a map using Shodan/Censys/BinaryEdge. |
...
| [waybackurls](https://github.com/tomnomnom/waybackurls) | 4k | Go | Fetches all URLs the Wayback Machine knows about for a domain. |
...
| [Osintgraph](https://github.com/XD-MHLOO/Osintgraph) | 796 | Python | Maps an Instagram target's followers/followees into Neo4j to visualize their network. |
| [youtube-metadata](https://github.com/mattwright324/youtube-metadata) | 494 | JavaScript | Gathers metadata for a YouTube video/playlist/channel with thumbnail reverse-search. |
...
| [SnapIntel](https://github.com/Kr0wZ/SnapIntel) | 320 | Python | Investigates Snapchat users: stories, spotlights, lenses, bitmojis and upload heatmaps. |
...
| [WhatsApp-OSINT](https://github.com/kinghacker0/WhatsApp-OSINT) | 713 | Python | Pulls WhatsApp profile pic, About/status, business verification and linked-device data from a number. |
...
| [c2patool](https://github.com/contentauth/c2pa-rs) | 366 | Rust | Official C2PA SDK and CLI to read, verify and write content-provenance manifests. |
...
| [ExifCleaner](https://github.com/szTheory/exifcleaner) | 2k | TypeScript | Cross-platform GUI (ExifTool-based) to view and strip metadata from images, video and PDFs. |
| [yt-dlp](https://github.com/yt-dlp/yt-dlp) | 176k | Python | Feature-rich CLI downloader for thousands of sites, used to pull source video and frames. |
...
| [Bellingcat ShadowFinder](https://github.com/bellingcat/ShadowFinder) | 588 | Python | Estimates possible locations of a photo from a known shadow length and timestamp. |
...
| [readsb](https://github.com/wiedehopf/readsb) | 629 | C | High-performance ADS-B decoder and feeder powering many receiver builds. |
| [tar1090](https://github.com/wiedehopf/tar1090) | 2k | JavaScript | Web interface for live visualization of ADS-B aircraft tracks. |
| [AIS-catcher](https://github.com/jvde-github/AIS-catcher) | 755 | C++ | Multi-SDR AIS receiver decoding ship NMEA with a built-in map server. |
...
| [TorCrawl.py](https://github.com/MikeMeliz/TorCrawl.py) | 523 | Python | Crawls and extracts regular or .onion pages through Tor with JSON/SQLite export. |
| [darc](https://github.com/JarryShaw/darc) | 224 | Python | Darkweb crawler using requests and Selenium to fetch, render and screenshot sites. |
...
| [Trace Labs OSINT VM](https://github.com/tracelabs/tlosint-live) | 823 | Kali-based live OSINT operating system preloaded with investigation tools for missing-persons CTFs. |
